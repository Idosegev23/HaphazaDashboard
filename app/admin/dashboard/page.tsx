    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-[#6c757d]">System Overview</p>
        </div>

        {/* Stats Grid */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Card>
            <div className="text-[#6c757d] text-sm mb-2">Total Users</div>
            <div className="text-3xl font-bold text-[#f2cc0d]">{usersCount || 0}</div>
          </Card>
          <Card>
            <div className="text-[#6c757d] text-sm mb-2">Creators</div>
            <div className="text-3xl font-bold text-[#f2cc0d]">{creatorsCount || 0}</div>
          </Card>
          <Card>
            <div className="text-[#6c757d] text-sm mb-2">Brands</div>
            <div className="text-3xl font-bold text-[#f2cc0d]">{brandsCount || 0}</div>
          </Card>
          <Card>
            <div className="text-[#6c757d] text-sm mb-2">Campaigns</div>
            <div className="text-3xl font-bold text-[#f2cc0d]">{campaignsCount || 0}</div>
          </Card>
          <Card>
            <div className="text-[#6c757d] text-sm mb-2">Active Tasks</div>
            <div className="text-3xl font-bold text-[#f2cc0d]">{tasksCount || 0}</div>
          </Card>
          <Card>
            <div className="text-[#6c757d] text-sm mb-2">Pending Payments</div>
